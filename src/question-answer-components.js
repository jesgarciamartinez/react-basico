...
import './App.css'
import {MoreLessButtons} from './components'
...
class Question extends React.Component {
  ...
  onChangeText = (e, i) => {
    /* Accedemos al valor que queremos extraer del evento de forma síncrona, no en la
      función que le pasamos a setState, que es asíncrono y nos puede dar problemas porque React reusa
          ...
          return (
            <AnswerComponent
              ...
              */
              ...
              upFunction={() => this.addAnswer(i)}
              downFunction={() => this.removeAnswer(i)}
            />
          )
        })}
      </Section>
